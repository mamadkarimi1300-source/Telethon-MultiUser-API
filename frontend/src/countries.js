// ISO 3166-1 countries and their international calling codes.
// Flags are Unicode so the selector stays dependency-free and lightweight.
export const COUNTRIES = [
  ...
  ["CN", "🇨🇳", "China", "86"], ["CX", "🇨🇽", "Christmas Island", "61"], ["CC", "🇨🇨", "Cocos Islands", "61"],
  ...
  ["IR", "🇮🇷", "ایران", "98"], ["IQ", "🇮🇶", "Iraq", "964"], ["IE", "🇮🇪", "Ireland", "353"],
  ...
  ["LU", "🇱🇺", "Luxembourg", "352"], ["MO", "🇲🇴", "Macao", "853"], ["MG", "🇲🇬", "Madagascar", "261"],
  ...
  ["NF", "🇳🇫", "Norfolk Island", "672"], ["MK", "🇲🇰", "North Macedonia", "389"], ["MP", "🇲🇵", "Northern Mariana Islands", "1670"],
  ...
  ["PR", "🇵🇷", "Puerto Rico", "1787"], ["QA", "🇶🇦", "Qatar", "974"], ["RE", "🇷🇪", "Réunion", "262"],
  ["RO", "🇷🇴", "Romania", "40"], ["RU", "🇷🇺", "Russia", "7"], ["RW", "🇷🇼", "Rwanda", "250"],
  ["BL", "🇧🇱", "Saint Barthélemy", "590"], ["SH", "🇸🇭", "Saint Helena", "290"], ["KN", "🇰🇳", "Saint Kitts and Nevis", "1869"],
  ...
  ["SR", "🇸🇷", "Suriname", "597"], ["SJ", "🇸🇯", "Svalbard and Jan Mayen", "47"], ["SE", "🇸🇪", "Sweden", "46"],
  ...
  ["UY", "🇺🇾", "Uruguay", "598"], ["VI", "🇻🇮", "US Virgin Islands", "1340"], ["UZ", "🇺🇿", "Uzbekistan", "998"],
  ["VU", "🇻🇺", "Vanuatu", "678"], ["VA", "🇻🇦", "Vatican City", "39"], ["VE", "🇻🇪", "Venezuela", "58"],
  ["VN", "🇻🇳", "Vietnam", "84"], ["WF", "🇼🇫", "Wallis and Futuna", "681"], ["EH", "🇪🇭", "Western Sahara", "212"],
  ["YE", "🇾🇪", "Yemen", "967"], ["ZM", "🇿🇲", "Zambia", "260"], ["ZW", "🇿🇼", "Zimbabwe", "263"],
].map(([code, flag, name, dialCode]) => ({ code, flag, name, dialCode }));
